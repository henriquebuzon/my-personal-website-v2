...
const AboutMe: FC = () => {
  return (
    <article className="flex flex-col md:items-center justify-center text-white w-full px-5 md:px-20 ">
      ...
      <div className="flex flex-col lg:flex-row space-y-12 lg:space-x-12 lg:space-y-0 mb-10 lg:mb-5">
