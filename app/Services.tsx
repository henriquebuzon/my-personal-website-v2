...
const Services = () => {
  return (
    <section className="relative flex flex-col justify-center max-w-[1250px] w-screen bg-white border-4 border-dark-purple rounded-3xl px-5 py-10 md:p-10 lg:px-20 lg:pt-16 lg:pb-[4.7rem] space-y-10 mb-20 lg:mb-36">
